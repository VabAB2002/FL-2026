...
Usage:
    python scripts/build_knowledge_graph.py              # Full build (233 files)
    python scripts/build_knowledge_graph.py --pilot      # Pilot mode (20 files)
    python scripts/build_knowledge_graph.py --limit 50   # Custom limit
"""
...
def verify_graph(client: Neo4jClient) -> dict:
    ...
    try:
        ...
        # Try simpler query for basic counts
...
def main() -> int:
    ...
    logger.info("  3. Run full build: python scripts/build_knowledge_graph.py")
    logger.info("")
